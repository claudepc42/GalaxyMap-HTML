...
;(() => {
  ...
  const nHII = (PARAMS.hiiCount|0) + Math.round(PARAMS.hiiCount*0.6) + REAL_HII.length + REAL_DSO.length + IMG_HII.length + Math.round(NEBULAE.length*PARAMS.nebDensity);
